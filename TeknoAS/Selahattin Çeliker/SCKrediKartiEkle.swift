...
struct SCKrediKartiEkle: View {
    @Environment(\.dismiss) var dismiss
    @ObservedObject var viewModel: SCKrediKartiViewModel
    ...
    @State private var sirketAdi = "SELAHATTİN ÇELİKER"
...
#Preview {
    SCKrediKartiEkle(viewModel: SCKrediKartiViewModel(modelContext: ModelContext(try! ModelContainer(for: SCKrediKarti.self))))
}
