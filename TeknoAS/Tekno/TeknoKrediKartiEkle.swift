...
struct TeknoKrediKartiEkle: View {
    @Environment(\.dismiss) var dismiss
    @ObservedObject var viewModel: TeknoKrediKartiViewModel
    ...
    @State private var sirketAdi = "Tekno İklimlendirme ve Müh. A.Ş."
...
#Preview {
    TeknoKrediKartiEkle(viewModel: TeknoKrediKartiViewModel(modelContext: ModelContext(try! ModelContainer(for: TeknoKrediKarti.self))))
}
