...
struct DCKrediKartiEkle: View {
    @Environment(\.dismiss) var dismiss
    @ObservedObject var viewModel: DCKrediKartiViewModel
    ...
    @State private var sirketAdi = "DİLARA ÇELİKER"
...
#Preview {
    DCKrediKartiEkle(viewModel: DCKrediKartiViewModel(modelContext: ModelContext(try! ModelContainer(for: DCKrediKarti.self))))
}
